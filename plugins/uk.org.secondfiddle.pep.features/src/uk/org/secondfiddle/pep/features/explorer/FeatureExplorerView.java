...
import uk.org.secondfiddle.pep.features.explorer.action.CollapseAllAction;
import uk.org.secondfiddle.pep.features.explorer.action.ContentProviderAction;
import uk.org.secondfiddle.pep.features.explorer.action.FeatureAndPluginCopyAction;
import uk.org.secondfiddle.pep.features.explorer.action.FeatureAndPluginPasteAction;
import uk.org.secondfiddle.pep.features.explorer.action.FilterFeatureChildAction;
import uk.org.secondfiddle.pep.features.explorer.action.ShowCalleesContentProviderAction;
import uk.org.secondfiddle.pep.features.explorer.action.ShowCallersContentProviderAction;
import uk.org.secondfiddle.pep.features.explorer.action.ShowPluginsAction;
import uk.org.secondfiddle.pep.features.explorer.action.ShowProductsAction;
import uk.org.secondfiddle.pep.features.explorer.action.ViewerFilterAction;
import uk.org.secondfiddle.pep.features.explorer.viewer.FeatureElementComparer;
import uk.org.secondfiddle.pep.features.explorer.viewer.FeatureTreeDragSupport;
import uk.org.secondfiddle.pep.features.explorer.viewer.FeatureTreeDropSupport;
import uk.org.secondfiddle.pep.features.explorer.viewer.FeatureTreeLabelProvider;
import uk.org.secondfiddle.pep.features.explorer.viewer.RootElementsFilteredTree;
